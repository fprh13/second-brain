...
recommended_title: 카우머치(carumuch) 프로젝트
recommended_project_folder: 10 Projects/카우머치(carumuch) 프로젝트
confidence: high
classifier: manual-review
repo: https://github.com/carumuch/carumuch-backend
---
...
## 진행 메모
- 공업사는 수리 이력과 가격 경쟁력을 바탕으로 입찰에 참여한다.
